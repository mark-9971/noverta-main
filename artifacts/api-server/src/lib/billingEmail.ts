 ...
 */
const FROM_EMAIL = "Trellis Billing <billing@trellis.education>";
...
<h2 style="margin:0;font-size:18px">Trellis Billing</h2>
</div>
...
<div style="text-align:center;padding:12px;color:#9ca3af;font-size:11px">Trellis SPED Compliance Platform</div>
</div>`;
}
