...
router.get("/students/:studentId/bips", async (req, res): Promise<void> => {
  try {
    ...
    const bips = await db.select({
      ...
      antecedentStrategiesStructured: behaviorInterventionPlansTable.antecedentStrategiesStructured,
        teachingStrategiesStructured: behaviorInterventionPlansTable.teachingStrategiesStructured,
        consequenceProceduresStructured: behaviorInterventionPlansTable.consequenceProceduresStructured,
        reinforcementComponentsStructured: behaviorInterventionPlansTable.reinforcementComponentsStructured,
...
router.post("/students/:studentId/bips", async (req, res): Promise<void> => {
  try {
    ...
    const { fbaId, createdBy, behaviorTargetId, targetBehavior, operationalDefinition, hypothesizedFunction,
      ...
      antecedentStrategiesStructured, teachingStrategiesStructured,
      consequenceProceduresStructured, reinforcementComponentsStructured, crisisSupportsStructured,
    } = req.body;
    ...
    const [bip] = await db.insert(behaviorInterventionPlansTable).values({
      ...
      antecedentStrategiesStructured: antecedentStrategiesStructured || null,
      teachingStrategiesStructured: teachingStrategiesStructured || null,
      consequenceProceduresStructured: consequenceProceduresStructured || null,
      reinforcementComponentsStructured: reinforcementComponentsStructured || null,
      crisisSupportsStructured: crisisSupportsStructured || null,
