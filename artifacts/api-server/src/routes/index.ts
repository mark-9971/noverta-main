...
import studentReinforcerRouter from "./studentReinforcer";
import supportIntensityRouter from "./supportIntensity";
...
import demoControlRouter from "./demoControl";
import demoResetScheduleRouter from "./demoResetSchedule";
...
import adminEmailDeliveriesRouter from "./adminEmailDeliveries";
import actionItemHandlingRouter from "./actionItemHandling";
import actionItemDismissalsRouter from "./actionItemDismissals";
...
router.use(studentReinforcerRouter);
router.use(supportIntensityRouter);
...
router.use(demoResetScheduleRouter);
router.use(trainingModeRouter);
router.use(adminEmailDeliveriesRouter);
router.use(actionItemHandlingRouter);
router.use(actionItemDismissalsRouter);
