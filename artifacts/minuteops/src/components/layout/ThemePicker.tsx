...
import { Palette, Check, Eye, Accessibility, X } from "lucide-react";
    ...
    <div className="relative">
      ...
      {open && (
        <>
          ...
          <div className="absolute bottom-full right-0 mb-2 bg-white rounded-xl shadow-xl border border-gray-200 w-72 z-50 overflow-hidden">
