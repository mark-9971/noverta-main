...
type Step = "student" | "service" | "duration" | "outcome" | "reason" | "note" | "review";
...
function NoteStep({ studentName, serviceTypeName, durationMinutes, outcome, note, makeupNeeded, onNoteChange, onContinue }: {
  studentName: string;
  serviceTypeName: string;
  durationMinutes: number;
...
function ReviewStep({ studentName, serviceTypeName, durationMinutes, outcome, note, makeupNeeded, missedReasonLabel, sessionDate, onSubmit, submitting }: {
  studentName: string;
  serviceTypeName: string;
  durationMinutes: number;
  outcome: "completed" | "missed";
