    ...
    <div className="p-4 md:p-6 lg:p-8 max-w-[1400px] mx-auto space-y-4 md:space-y-6">
      <div className="flex items-start sm:items-center justify-between gap-3 flex-wrap">
        <div>
          ...
          <p className="text-xs md:text-sm text-gray-400 mt-1">{blockList.length} recurring schedule blocks</p>
        </div>
            ...
            <table className="w-full border-collapse">
              <thead>
                <tr>
                  ...
                  {DAYS.map(day => (
                    <th key={day} className="p-2.5 border-b border-gray-100 bg-gray-50/50 text-[12px] font-semibold text-gray-600 text-center min-w-[150px]">
                      {DAY_LABELS[day]}
                    </th>
                  ))}
                </tr>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-gray-100">
                  <th className="text-left px-5 py-3 text-[11px] font-semibold text-gray-400 uppercase tracking-wider">Day</th>
              ...
              <tbody className="divide-y divide-gray-50">
                {filtered.sort((a, b) => {
                  ...
                  <tr key={block.id} className="hover:bg-gray-50/50 transition-colors">
                    <td className="px-5 py-3 text-[13px] font-medium text-gray-700">{DAY_LABELS[block.dayOfWeek] ?? block.dayOfWeek}</td>
