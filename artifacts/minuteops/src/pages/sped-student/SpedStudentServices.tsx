    ...
    <div className="p-4 md:p-6 space-y-6 max-w-4xl mx-auto">
              ...
              <Card key={i} className={`border-2 ${colors.ring}`}>
                <CardHeader className="pb-2">
                  <div className="flex items-start justify-between">
                    <div>
                      ...
                      <p className="text-xs text-slate-400 mt-0.5">{svc.deliveryType || "direct"} · {svc.requiredMinutes} min/week required</p>
                    </div>
                ...
                <CardContent className="space-y-3">
                  <div>
                    ...
                    <p className="text-[11px] text-slate-400 mt-1">{stats.pct}% of monthly requirement delivered</p>
                  </div>
      ...
      <Card className="bg-slate-50 border-slate-200">
        <CardContent className="p-4 flex items-start gap-3">
          ...
          <div>
            <p className="text-sm font-medium text-slate-700">How services are tracked</p>
