...
import { getStudentDashboard, getStudentGradesSummary, listStudentsWithEnrollments } from "@workspace/api-client-react";
...
function SelectStudentPrompt() {
  ...
  useEffect(() => {
    listStudentsWithEnrollments().then(setStudents);
  }, []);
