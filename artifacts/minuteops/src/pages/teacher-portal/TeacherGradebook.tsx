  ...
  return (
    <div className="p-4 md:p-6 space-y-6 max-w-5xl mx-auto">
      <div>
        ...
        <p className="text-slate-500 mt-1">Select a class to view grades</p>
      </div>
            ...
            <Card className="hover:shadow-md transition-all cursor-pointer group">
              <CardContent className="p-4 flex items-center gap-4">
                ...
                <div className="flex-1">
                  <p className="font-semibold text-slate-700 group-hover:text-emerald-700">{c.name}</p>
                  <p className="text-sm text-slate-400">Period {c.period} · {c.studentCount} students · {c.subject}</p>
                </div>
