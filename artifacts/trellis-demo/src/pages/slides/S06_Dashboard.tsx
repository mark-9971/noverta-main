...
export default function S06_Dashboard() {
  return (
    <div className="relative w-screen h-screen overflow-hidden bg-gradient-to-br from-[#f8f9fa] to-[#ecfdf5]">
      <div className="relative z-10 flex flex-col h-full px-[5vw] py-[4vh]">
        <div className="flex items-center justify-between mb-[2vh]">
          <div>
            <p className="font-body text-[1.3vw] text-primary font-semibold tracking-widest uppercase mb-[0.5vh]">Live Product</p>
            <h2 className="font-display text-[3vw] font-bold text-text tracking-tight">District Command Center</h2>
          </div>
