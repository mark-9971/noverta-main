...
export default function S10_Alerts() {
  return (
    <div className="relative w-screen h-screen overflow-hidden bg-gradient-to-br from-[#f8f9fa] to-[#ecfdf5]">
      <div className="relative z-10 flex flex-col h-full px-[5vw] py-[4vh]">
        ...
        <div className="flex-1 rounded-[1vw] overflow-hidden shadow-2xl border border-gray-200 bg-white">
          <img src={`${base}alerts.jpg`} crossOrigin="anonymous" className="w-full h-full object-cover object-top" alt="Alerts System" />
        </div>
        <p className="font-body text-[1.3vw] text-muted mt-[1.5vh] text-center">Cost-avoidance alerts flag at-risk services with estimated dollar exposure. Resolve or snooze with one click.</p>
      </div>
    </div>
  );
}
