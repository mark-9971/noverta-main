  ...
  return (
    <div className="relative w-screen h-screen overflow-hidden bg-gradient-to-br from-[#f8f9fa] to-[#ecfdf5]">
      <div className="relative z-10 flex flex-col justify-center h-full px-[8vw]">
        ...
        <h2 className="font-display text-[3.5vw] font-bold text-text tracking-tight leading-[1.1] mb-[5vh]">Why Noverta wins.</h2>
        <div className="grid grid-cols-2 gap-[3vw]">
          <div className="flex gap-[1.5vw] items-start">
            ...
            <div>
              ...
              <p className="font-body text-[1.3vw] text-muted">Competitors do compliance OR clinical data. Noverta does both, so session logs automatically feed IEP progress graphs.</p>
            </div>
          </div>
          <div className="flex gap-[1.5vw] items-start">
            <div className="w-[3vw] h-[3vw] flex-shrink-0 rounded-full bg-primary/10 flex items-center justify-center mt-[0.3vh]">
            ...
            <div>
              ...
              <p className="font-body text-[1.3vw] text-muted">No competitor surfaces dollar-denominated risk exposure per student. Noverta tells you "this gap will cost $436" before it happens.</p>
            </div>
          </div>
          <div className="flex gap-[1.5vw] items-start">
            <div className="w-[3vw] h-[3vw] flex-shrink-0 rounded-full bg-primary/10 flex items-center justify-center mt-[0.3vh]">
