 ...
 * Also restore:
 *   - _clerk-restore/lib/role-context.tsx  → src/lib/role-context.tsx
 *   - _clerk-restore/lib/auth-fetch.ts     → src/lib/auth-fetch.ts
 *   - _clerk-restore/pages/sign-in.tsx     → src/pages/sign-in.tsx
 *   - _clerk-restore/pages/sign-up.tsx     → src/pages/sign-up.tsx
 *   - _clerk-restore/components/layout/AppLayout-signout-snippet.tsx (see note)
 *   - Backend: restore _clerk-restore/middlewares/auth.ts, app.ts, auditLog.ts
 *   - Remove src/routes/auth.ts and its line in src/routes/index.ts
 */
