...
const NOVERTA_GREEN = "#059669";
const NOVERTA_GREEN_DARK = "#047857";
...
const SHARED_CSS = `
  * { box-sizing: border-box; }
  ...
  .doc-header {
    border-bottom: 3px solid ${NOVERTA_GREEN};
    padding-bottom: 14px;
    margin-bottom: 20px;
    display: flex;
  ...
  h2 {
    font-size: 13px;
    font-weight: bold;
    color: ${NOVERTA_GREEN_DARK};
    border-bottom: 1.5px solid ${NOVERTA_GREEN};
    padding-bottom: 4px;
    margin: 20px 0 8px;
  ...
  .field-box {
    background: #f9fafb;
    border: 1px solid ${GRAY_200};
    border-left: 3px solid ${NOVERTA_GREEN};
    border-radius: 4px;
    padding: 10px 12px;
    margin-bottom: 10px;
    font-size: 12px;
...
<body>
  ...
  <div class="page-wrap">
    ...
    <div class="footer">
      ${footerHtml}
      <p style="margin:4px 0">Generated by Noverta · ${dateStr}</p>
    </div>
  </div>
</body>
</html>`;
  ...
  <div class="page">
    <div class="header">
      ...
      <div class="header-right">
        ...
        <div style="margin-top:2px;font-size:9px;color:#d1d5db">Noverta SPED Management Platform</div>
      </div>
    </div>
    ...
    <div class="footer">
      Generated by Noverta SPED Management Platform &nbsp;·&nbsp; ${esc(dateStr)} &nbsp;·&nbsp; Confidential — For Board/Superintendent Use Only
    </div>
  </div>
</body>
</html>`;
...
<body>
  <div class="page-wrap">
    ...
    ${coveredSection}
    <div class="footer">
      <p style="margin:4px 0">Generated by Noverta · ${esc(displayDate)} · For internal use only.</p>
    </div>
  </div>
</body>
</html>`;
...
function boolField(label: string, value: boolean | null | undefined, note?: string | null): string {
  const icon = value ? `<span style="color:${NOVERTA_GREEN}">✓</span>` : `<span style="color:#6b7280">—</span>`;
