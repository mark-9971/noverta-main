...
export default function IepBuilderLanding() {
  ...
  const inProgressCount = students.filter(s => draftsMap.has(s.id)).length;
    ...
    <div className="p-4 md:p-6 lg:p-8 max-w-[700px] mx-auto space-y-6" data-tour-id="showcase-iep-builder">
      <div>
        ...
        <p className="text-sm text-gray-400 mt-1">
          Search by student name, goal, or accommodation to find and open an IEP draft.
        </p>
      ...
      <IepSearch embedded routeToBuilder />

      <div className="border-t border-gray-100 pt-2">
        <p className="text-xs font-semibold text-gray-400 uppercase tracking-wide mb-3">Or browse all students</p>
