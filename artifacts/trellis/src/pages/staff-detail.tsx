...
import {
  ...
  Mail, Phone, Building, Shield, ChevronRight, ClipboardCheck, Stethoscope, Save, Loader2, Bell
} from "lucide-react";
...
function NotificationPrefsCard({ staff, onSave }: { staff: any; onSave: (s: any) => void }) {
...
export default function StaffDetail() {
  ...
  return (
    <div className="p-4 md:p-6 lg:p-8 max-w-[1400px] mx-auto space-y-5">
      ...
      <NotificationPrefsCard staff={staff} onSave={(updated: any) => setStaff(updated)} />
