...
- Clerk issues short-lived **JSON Web Tokens (JWTs)** that expire after **1 hour** by default
...
- Session tokens expire after 1 hour of inactivity (configurable by district admin via Clerk settings)
