...
- Name: incident-form-wizard.spec.ts >> NewIncidentForm wizard — UI >> walks through all 5 steps, submits, and the new incident is confirmed in list and API
- Location: tests/incident-form-wizard.spec.ts:309:3
