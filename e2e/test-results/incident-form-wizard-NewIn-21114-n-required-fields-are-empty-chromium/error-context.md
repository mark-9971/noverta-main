...
- Name: incident-form-wizard.spec.ts >> NewIncidentForm wizard — UI >> step 1 shows error and blocks advancement when required fields are empty
- Location: tests/incident-form-wizard.spec.ts:248:3
