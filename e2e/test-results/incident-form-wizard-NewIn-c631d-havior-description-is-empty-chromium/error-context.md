...
- Name: incident-form-wizard.spec.ts >> NewIncidentForm wizard — UI >> step 2 shows error and blocks advancement when behavior description is empty
- Location: tests/incident-form-wizard.spec.ts:276:3
