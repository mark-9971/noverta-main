...
- Name: incident-lifecycle.spec.ts >> Incident lifecycle and parent notification (603 CMR 46.00) >> generates a notification draft from incident data via the generate-draft endpoint
- Location: tests/incident-lifecycle.spec.ts:541:3
