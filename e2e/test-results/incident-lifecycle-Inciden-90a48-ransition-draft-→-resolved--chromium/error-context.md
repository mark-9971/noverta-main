...
- Name: incident-lifecycle.spec.ts >> Incident lifecycle and parent notification (603 CMR 46.00) >> rejects invalid transition (draft → resolved)
- Location: tests/incident-lifecycle.spec.ts:284:3
