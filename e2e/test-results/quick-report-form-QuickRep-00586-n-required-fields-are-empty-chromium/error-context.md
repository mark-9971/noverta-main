...
- Name: quick-report-form.spec.ts >> QuickReportForm — UI >> step 1 shows error and blocks advancement when required fields are empty
- Location: tests/quick-report-form.spec.ts:157:3
