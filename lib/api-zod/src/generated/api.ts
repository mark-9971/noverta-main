 ...
 */
export const GetWorkloadSummaryQueryParams = zod.object({
  thresholdHours: zod.coerce.number().nullish(),
  schoolId: zod.coerce.number().nullish(),
  districtId: zod.coerce.number().nullish(),
});

export const GetWorkloadSummaryResponseItem = zod.object({}).passthrough();
export const GetWorkloadSummaryResponse = zod.array(
  GetWorkloadSummaryResponseItem,
);
...
export const ListAbsencesResponseItem = zod.object({}).passthrough();
export const ListAbsencesResponse = zod.array(ListAbsencesResponseItem);
...
export const DeleteAbsenceResponse = zod.object({}).passthrough();
...
export const ListUncoveredSessionsResponseItem = zod.object({}).passthrough();
export const ListUncoveredSessionsResponse = zod.array(
  ListUncoveredSessionsResponseItem,
);
...
export const ListAlertsQueryParams = zod.object({
  ...
  snoozed: zod.coerce.string().nullish(),
  studentId: zod.coerce.number().nullish(),
  staffId: zod.coerce.number().nullish(),
 ...
 */
export const BulkResolveAlertsBody = zod.object({
  ids: zod.array(zod.number()),
  resolvedNote: zod.string().nullish(),
});

export const BulkResolveAlertsResponse = zod.object({
  resolved: zod.number(),
});
